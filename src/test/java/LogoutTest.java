...
public class LogoutTest {
    ...
    public void tearDown() {
        // Удаление пользователя (на случай если тест упал до удаления)
        if (accessToken != null) {
    ...
    public void testSuccessfulLogout(Browser browser) {
        ...
        assertTrue(loginPage.isLoginButtonDisplayed(), "Должна отображаться страница входа");
